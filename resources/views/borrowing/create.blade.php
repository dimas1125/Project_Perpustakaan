        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="radio" name="ket" value="Kembali" id="kembali"> <label for="kembali">Kembali</label>
                    <input type="radio" name="ket" value="Belum Kembali" id="belum"> <label for="belum">Belum Kembali</label>
                </div>
            </div>
